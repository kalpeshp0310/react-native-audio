...
Java_com_rnim_rn_audio_voice_android_LibFlac_init(JNIEnv *env, jobject instance) {
...
Java_com_rnim_rn_audio_voice_android_LibFlac_setMetadata(JNIEnv *env, jobject instance,
...
Java_com_rnim_rn_audio_voice_android_LibFlac_encode(JNIEnv *env, jobject instance,
                                                       jlong cPointer,
...
Java_com_rnim_rn_audio_voice_android_LibFlac_release(JNIEnv *env, jobject instance,
                                                        jlong cPointer) {
...
JNIEXPORT void JNICALL
Java_com_rnim_rn_audio_voice_android_LibFlac_finish(JNIEnv *env, jobject instance,
                                                       jlong cPointer) {
...
JNIEXPORT jboolean JNICALL
Java_com_rnim_rn_audio_voice_android_LibFlac_convertRawPCM(JNIEnv *env, jclass type,
